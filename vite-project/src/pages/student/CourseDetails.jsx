...
const CourseDetails = () => {
  ...
  return  courseData?(
    <>
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left bg-gradient-to-b from-green-100 via-green200 to-green-300'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        dangerouslySetInnerHTML={{__html:courseData.courseDescription.slice(0,200)}} />
            ...
            <div className='pt-8 text-gray-800'>
              ...
              <div>
                <h3 className='text-xl font-semibold text-gray-800 mt-10'>Course Descriptions</h3>
      ...
      {/*right */}
      <div className='max-w-course-card z-10 shadow-course-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]' >
      {
        ...
        <div className='p-5'>
          ...
          <button onClick={enrollCourse} className='md:mt-6 w-full py-3 rounded bg-blue-600 text-white font-medium'>{isAlreadyEnrolled? 'Already Enrolled' : 'Enroll Now'}</button>
          <div className='pt-6'>
            <p className='md:text-xl text-lg font-medium text-gray-800'>What's in the course?</p>
            <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
              <li>Step by step hands-on project guidance</li>
              <li>Resources and source code</li>
              <li>Every week assignments/tests with proper guidance</li>
