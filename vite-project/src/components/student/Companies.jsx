...
const Companies = () => {
  return (
    <div className='pt-16'>
        <p className='text-base text-gray-500 text-center'>Trusted byLearners from</p>
        <div className="flex flex-wrap items-center justify-center gap-6 md-gap-16 md:mt-10 mt-15">
